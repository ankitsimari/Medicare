...
<h2 className="text-center pt-4 mt-5 pb-4">Frequently Asked <span className="themeColor">Questions</span></h2>
    ...
    <div style={{width:"83%",display:"block", margin:"auto"}} data-aos="">
      <Accordion > 
        <AccordionSummary
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography>Can I see reviews or ratings for doctors on your platform?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography>What if I need to see a specialist? Can I book directly with them?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
