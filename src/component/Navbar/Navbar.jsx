...
<nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div className="container text-black text-center text-md-start">
      <Link className="navbar-brand fw-bolder fs-2" to="/"><img src="/img/logo.png" alt=""/> &nbsp; &nbsp;MediCare</Link>
      ...
      <div className="collapse navbar-collapse" id="navbarText">
        <ul className="navbar-nav mx-auto mb-2 mb-lg-0 ps-4 ps-lg-0 text-uppercase">
          ...
          <li className="nav-item">
            <NavLink className="nav-link fw-bold text-black" to="/doctors">doctors</NavLink>
          </li>
          <li className="nav-item">
            <NavLink  className="nav-link fw-bold text-black" to="/appointments">Appointments</NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link fw-bold text-black" to="/contact">contact</NavLink>
          </li>
        </ul>
